                        ...
                        <div className="space-y-8">
                            {journeySteps.map((step, index) => (
                                ...
                                >
                                    ...
                                    {/* Icon - Ensured consistent centering */}
                                    <motion.div
                                        whileHover={{ scale: 1.1 }}
                                        className="relative z-10 flex-shrink-0 w-12 h-12 bg-gradient-to-br from-accent-500 to-primary-500 rounded-full flex items-center justify-center text-white shadow-lg"
                                    >
                                        {step.icon}
                                    </motion.div>
